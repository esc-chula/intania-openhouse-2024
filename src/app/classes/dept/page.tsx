...
export default function Dept() {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-between pb-9">
      <Header />
      <div className="flex w-full flex-col items-center gap-7 py-10">
        <div className="flex w-full px-2.5">
          <div className="relative flex h-[26rem] w-full rounded-[30px] bg-button-glass shadow-button-glass ring-[1.5px] ring-white ring-opacity-30">
            <div className="absolute left-4 top-4 flex h-96 w-[90%] justify-center rounded-[18px] bg-[#D9D9D9]">
